...
if("FALSE" STREQUAL "TRUE")
  ...
  set(caterpie_descripton_DEVEL_PREFIX /home/abhilash/ROS_workspaces/caterpie_ws/devel)
  ...
  set(caterpie_descripton_INSTALL_PREFIX /home/abhilash/ROS_workspaces/caterpie_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'caterpie_descripton' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT caterpie_descripton_NUM_DUMMY_TARGETS)
      set(caterpie_descripton_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::caterpie_descripton::wrapped-linker-option${caterpie_descripton_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR caterpie_descripton_NUM_DUMMY_TARGETS "${caterpie_descripton_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::caterpie_descripton::wrapped-linker-option${caterpie_descripton_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND caterpie_descripton_LIBRARIES "${interface_target_name}")
